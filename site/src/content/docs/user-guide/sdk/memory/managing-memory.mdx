...
description: "Configure a Strands memory manager: recall through a tool, automatic prompt injection, extraction from the conversation, programmatic reads and writes, and custom stores."
tags: [memory]
sourceLinks:
...
Once a [memory manager is attached to an agent](./overview), the manager decides what the agent reads and writes across the stores you give it. Recall and injection are on by default; this page covers turning on writes, tuning each of the three jobs, reaching memory programmatically, and backing it with your own store.

Writing is opt-in, and comes in two modes:
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory_imports.ts:turn_on_writes_imports"

--8<-- "user-guide/sdk/memory/managing-memory.ts:turn_on_writes"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory_imports.ts:multi_store_imports"

--8<-- "user-guide/sdk/memory/managing-memory.ts:multi_store"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory_imports.ts:search_tool_config_imports"

--8<-- "user-guide/sdk/memory/managing-memory.ts:search_tool_config"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory_imports.ts:injection_custom_imports"

--8<-- "user-guide/sdk/memory/managing-memory.ts:injection_custom"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory_imports.ts:extraction_defaults_imports"

--8<-- "user-guide/sdk/memory/managing-memory.ts:extraction_defaults"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory_imports.ts:extraction_custom_imports"

--8<-- "user-guide/sdk/memory/managing-memory.ts:extraction_custom"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory_imports.ts:custom_trigger_imports"

--8<-- "user-guide/sdk/memory/managing-memory.ts:custom_trigger"
```
</Tab>
</Tabs>
...
`await agent.shutdown()` does the same flush through the agent, and scoping the agent with `async with agent:` runs that shutdown when the block exits, including on a thrown error:
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory.ts:flush"
```
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory.ts:programmatic"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory_imports.ts:custom_store_imports"

--8<-- "user-guide/sdk/memory/managing-memory.ts:custom_store"
```
</Tab>
</Tabs>
...
```typescript
--8<-- "user-guide/sdk/memory/managing-memory_imports.ts:server_side_store_imports"

--8<-- "user-guide/sdk/memory/managing-memory.ts:server_side_store"
```
</Tab>
</Tabs>
...
- [Give your agent long-term memory](./overview) - the memory hub: what the manager does and the stores it works with.
