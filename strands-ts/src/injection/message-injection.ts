...
import type { InjectionMiddlewareOptions, InjectionTrigger, ProvideContext } from './types.js'

/**
 * Builds an `InvokeModelStage` `Input` handler that folds {@link InjectionMiddlewareOptions.provide}'s
 ...
 * @returns A predicate that, given the {@link ProvideContext}, returns whether to inject this call
 */
export function resolveTrigger(
  trigger: InjectionTrigger | ((context: ProvideContext) => boolean) | undefined
): (context: ProvideContext) => boolean {
